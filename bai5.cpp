...
int main()
{
	...
	int a[10][10];
	FILE *in, *out1, *out2;
	in = fopen("D:\\BICHNGOC\\Chuong 7 toan roi rac\\input2.txt", "r");
	out1 = fopen("D:\\BICHNGOC\\Chuong 7 toan roi rac\\input2_1.txt", "w");
	out2 = fopen("D:\\BICHNGOC\\Chuong 7 toan roi rac\\input2_2.txt", "w");
